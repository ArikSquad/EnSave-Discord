...
class Spy(commands.Cog, description="Spying"):
    ...
    async def spy(self, interaction: discord.Interaction, channel: discord.TextChannel, toggle: bool = None) -> None:
        if toggle:
        ...
        db.set_guild_spy_channel(interaction.guild.id, channel.id)
